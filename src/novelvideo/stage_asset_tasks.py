...
def resolve_scene_360_image_provider(provider: str = "") -> str:
    """Cloud scene-360 generation always uses the configured NewAPI transport."""
    return "newapi"


def resolve_scene_360_image_model(provider: str = "", model: str = "") -> str:
    """Return the globally bound scene-360 model; overrides are ignored."""
    from novelvideo.model_catalog import model_runtime_resolver

    return model_runtime_resolver.resolve("scene_360_image").model_id
