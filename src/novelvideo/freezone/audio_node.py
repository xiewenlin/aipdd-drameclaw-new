...
def _newapi_audio_endpoint(base_url: str | None = None, feature_id: str = "character_tts") -> str:
    del base_url
    from novelvideo.model_catalog import model_runtime_resolver

    resolved_base_url = model_runtime_resolver.resolve(feature_id).base_url
...
async def _write_newapi_audio_speech(
    *,
    ...
    key, resolved_base_url = resolved.api_key, resolved.base_url
    ...
    async with httpx.AsyncClient(timeout=timeout_seconds, follow_redirects=True) as client:
        endpoint = _newapi_audio_endpoint(resolved_base_url, feature_id=feature_id)
...
async def generate_freezone_audio_eleven_music(
    *,
    ...
    model_name = model_runtime_resolver.resolve("background_music").model_id
    reservation_id = ""
    try:
