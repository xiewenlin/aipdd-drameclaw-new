...
def resolve_prop_reference_image_model() -> str:
    """Return the globally bound prop-reference model."""
    from novelvideo.model_catalog import model_runtime_resolver

    return model_runtime_resolver.resolve("prop_reference_image").model_id
...
async def generate_prop_reference(
    ...
    resolved = model_runtime_resolver.resolve("prop_reference_image")
    provider = "newapi"
