...
class IndexTTS2FalClient:
    ...
    All requests route through the globally configured NewAPI gateway.
    """
    ...
    def __init__(
        ...
        *,
        ...
        from novelvideo.config import INDEXTTS2_TIMEOUT_SECONDS
    ...
    async def generate(
        ...
        *,
        ...
        if not self.api_key:
            return TTSResult(success=False, error="NewAPI API key is not configured")
