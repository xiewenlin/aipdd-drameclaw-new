...
$portableExe = Join-Path $releaseRoot "Gulong-ShortDrama-Native-2.0.0-x64.exe"
...
try {
    & $makeNsis (Join-Path $desktopRoot "installer.nsi")
...
Get-Item -LiteralPath $portableExe, (Join-Path $releaseRoot "Gulong-ShortDrama-Native-Setup-2.0.0-x64.exe") |
